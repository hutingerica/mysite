...
<VideoPlayer src="https://vimeo.com/677102636"/>
...
The outcome is that we have an MVP that can get a lot of feedback from different stakeholders. This project marks the start of a new journey for Taiwanese government design system, where I realised this is a design system designed with stakeholders not to them. To see impacts on the design system, we really need to solve problems that design system users are facing. At the same time, from those learning experiences, to make things easier for everyone, we’re designing more design patterns that can really help stakeholders avoid repetitive work and make their work reusable and save time. 