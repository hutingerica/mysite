...
The senses of collaboration and connection to each other shows an interesting reconnection to ingredients. To explore the opportunity of leverage cooking together further, I organised workshops "Let's make dumpling in 100 ways" to cook together with participants. We brainstorm dumpling recipes that contains daily food surplus and discuss how to make them delicious. This project is a work in progress, to be contunued for further updates.
<StyledImage objectFit="scale-down" srcLeft="beyondflavour-02.png" srcRight="beyondflavour-03.png" flexLeft={1} flexRight={1} width={100} bg="transparent" gap={0} />
