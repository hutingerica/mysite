...
<Highlight width={100}>How might we make households aware of the preciousness of food in order to help them reduce food waste?</Highlight>

##### Observation and Thought
There are many existing solutions or products aiming to reduce food waste. However, most solutions, for example, breadcrumb-made beers are designed to be consumed with a competitive market price again. As a result, people jump into the decision making of buying beers, not the process of considering the value of food environmentally.

<Highlight width={100}>What if… Change the role of consumer: Can consumers become creators against food waste?</Highlight>

> What we have from past (fermentation)
> Reasons to be a creator
> 做中學習食物與環境與人類的關係
> 讓大家反思「食物好取得，但是我們是不是讓他們太容易進入到垃圾桶了？」

<Highlight width={100}>How might we encourage people to become creators ?</Highlight>

> Going vegan is a big change from the original life.
> The solutions need to fit in the existing lifestyles. (time limit / buy a lot)
...
<StyledImage objectFit="cover" srcLeft="beyondflavour-05.png" srcRight="beyondflavour-06.png" flexLeft={1} flexRight={1} width={100} bg="transparent" gap={1}/>

<StyledImage objectFit="cover" srcLeft="beyondflavour-07.png" srcRight="beyondflavour-08.png" flexLeft={1} flexRight={1} width={100} bg="transparent" gap={1}/>

<StyledImage objectFit="cover" srcLeft="beyondflavour-12.png" flexLeft={1} flexRight={0} width={100} bg="transparent" gap={1}/>
...
Cooking Experiement
<HighlightwithPic picSrc="beyondflavour-01.png" picFlex={2} textFlex={1} bg="transparent" gap={1}>Together, we are confident that we can raise a generation of socially minded citizens with the skills to bring real change.</HighlightwithPic>

用水餃讓大家動起來
<StyledImage objectFit="cover" srcLeft="beyondflavour-02.png" srcRight="beyondflavour-03.png" flexLeft={1} flexRight={1} width={100} bg="transparent" gap={1}/>
...
「一起包水餃」的工作坊
<StyledImage objectFit="cover" srcLeft="beyondflavour-04.png" flexLeft={1} flexRight={0} width={100} bg="transparent" gap={1}/>

市場影片 (caption工作方裡面放的影片)
